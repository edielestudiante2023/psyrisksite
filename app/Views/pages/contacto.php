...
<section>
    <div class="container">
        <div class="split">
            ...
            <div class="form-card">
                <h2 style="margin-top:0;">¿Cómo prefieres contactarnos?</h2>
                <p style="color:var(--color-text-soft); margin-bottom:24px;">Elige el canal que más te acomode. Te respondemos rápido por cualquiera de los dos.</p>

                <div style="display:flex; flex-direction:column; gap:14px;">
                    <a href="https://cycloidtalent.com/contacto"
                       target="_blank"
                       rel="noopener"
                       class="btn btn-primary btn-lg"
                       style="width:100%; justify-content:center; display:inline-flex; align-items:center; gap:10px;">
                    ...
                    <a href="https://wa.me/573229074371?text=Hola,%20quiero%20m%C3%A1s%20informaci%C3%B3n%20de%20PsyRisk"
                       target="_blank"
                       rel="noopener"
                       class="btn btn-lg"
                       style="width:100%; justify-content:center; display:inline-flex; align-items:center; gap:10px; background:#25D366; color:#fff;">
                ...
                <p style="color:var(--color-muted); font-size:.85rem; margin-top:18px; text-align:center;">
                    Atención de lunes a viernes · 8:00 a.m. – 6:00 p.m.
                </p>
            </div>

            <?php /* ============================================================
                FORMULARIO INTERNO — DESHABILITADO (uso futuro)
                Se reemplazó por dos botones (formulario externo + WhatsApp).
                Para reactivar: descomentar este bloque y eliminar el bloque de arriba.
            ============================================================ */ ?>
            <?php /*
            <div class="form-card">
                <?php if (! empty($errors)): ?>
